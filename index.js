...
demo.innerHTML = projects.reduce((output, project) => {
  return (
    ...
    <div class="flex-column">
      ...
      <ul class="flex">
          ${project.technologies.map(x => `<li class="list-sumbua">${x}</li><span> <img src="images/image3.png" alt="css" /></span>`)}
      </ul>
      <button class="seeproject-btn" type="button" id="seeproject" data-open ="modal1">See Project</button>
    </div>
  </div>
  `
  );
